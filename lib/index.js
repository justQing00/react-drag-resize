  ...
  function DragResizeContainer() {
    ...
    return _ret = (_temp = (_this3 = _possibleConstructorReturn(this, (_ref3 = DragResizeContainer.__proto__ || Object.getPrototypeOf(DragResizeContainer)).call.apply(_ref3, [this].concat(args))), _this3), _this3.state = {
      ...
      return function (e, position) {
        ...
        var _this3$props$zoomScal = _this3.props.zoomScaleRate,
            zoomScaleRate = _this3$props$zoomScal === undefined ? 1 : _this3$props$zoomScal;
    ...
    }, _this3.onDrag = function (key) {
      return function (e, position) {
        var _this3$props$zoomScal2 = _this3.props.zoomScaleRate,
            zoomScaleRate = _this3$props$zoomScal2 === undefined ? 1 : _this3$props$zoomScal2;
  ...
  _createClass(DragResizeContainer, [{
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          zoomScaleRate = _props2.zoomScaleRate,
          other = _objectWithoutProperties(_props2, ['children', 'dragProps', 'resizeProps', 'layout', 'onLayoutChange', 'zoomScaleRate']);
        ...
        tempChildren.map(function (single) {
          ...
          return React.createElement(
            ...
            _extends({
              ...
              dragProps: Object.assign({}, dragProps, { onStop: _this4.onDragStop(key), onDrag: _this4.onDrag(key) }),
