...
var DragResizeContainer = function (_React$Component2) {
  ...
  function DragResizeContainer() {
    ...
    return _ret = (_temp = (_this2 = _possibleConstructorReturn(this, (_ref3 = DragResizeContainer.__proto__ || Object.getPrototypeOf(DragResizeContainer)).call.apply(_ref3, [this].concat(args))), _this2), _this2.state = {
      parentNode: null
  ...
  _createClass(DragResizeContainer, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (!(0, _lodash2.default)(layout, this.props.layout) || Object.keys(this.childrenMap).length !== layout.length) {
        this.childrenMap = transLayoutToMap(layout);
      }
    }
  }, {
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        tempChildren.map(function (single) {
          var key = single.key;
          if (!_this3.childrenMap[key] && key) _this3.childrenMap[key] = defaultChildProps;
          return React.createElement(
            DragResize,
            _extends({
              key: key
