  ...
  function DragResizeContainer() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DragResizeContainer.__proto__ || Object.getPrototypeOf(DragResizeContainer)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return function () {
        ...
        if (scale === 1) return;
        _this.currentChildMap = _this.childrenMap[key];
      };
      ...
      return function (e, direction, refToElement, delta) {
        ...
        if (scale === 1) return;
        var temp = {
          width: _this.currentChildMap.width + delta.width / scale,
          height: _this.currentChildMap.height + delta.height / scale
        };
      ...
      return function (e, direction, refToElement, delta) {
        var _ref3 = _this.props.resizeProps || {},
            onResizeStop = _ref3.onResizeStop;
      ...
      return function (e, position) {
        var _ref4 = _this.props.dragProps || {},
            onStop = _ref4.onStop;
      ...
      return function (e, position) {
        var _this$props$scale5 = _this.props.scale,
            scale = _this$props$scale5 === undefined ? 1 : _this$props$scale5;
        ...
        var temp = { x: lastX + deltaX / scale, y: lastY + deltaY / scale };
        if (key) _this.childrenMap[key] = Object.assign({}, _this.childrenMap[key], temp);
        _this.setState({}); // force update when drag, just reduce size change render
      };
...
var transLayoutToMap = function transLayoutToMap() {
  ...
  var childrenMap = {};
  layout.forEach(function (_ref5) {
    var key = _ref5.key,
        other = _objectWithoutProperties(_ref5, ['key']);
