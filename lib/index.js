        ...
        tempChildren.map(function (single) {
          ...
          return React.createElement(
            ...
            _extends({
              ...
              resizeProps: Object.assign({}, resizeProps, _extends({ onResizeStop: _this3.onResizeStop(key) }, _this3.sizeMap[key])),
              dragProps: Object.assign({}, dragProps, { onStop: _this3.onDragStop(key), position: _this3.positionMap[key] })
            }),
            single
          );
        })
