        ...
        tempChildren.map(function (single) {
          return React.createElement(
            ...
            _extends({
              ...
              resizeProps: Object.assign({}, resizeProps, { onResizeStop: _this3.onResizeStop(single.key) }),
              dragProps: Object.assign({}, dragProps, { onStop: _this3.onDragStop(single.key) })
            }),
            single
          );
        })
